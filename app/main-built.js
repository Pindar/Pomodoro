...
define("backbone", ['libs/backbone'], function(){
    return Backbone;
});
...
define('libs/backbone-localstorage',['underscore', 'backbone'], function (_, Backbone) {
    return Store;
});

define('src/model/task',['order!backbone', 'order!libs/backbone-localstorage'], function(Backbone, Store) {
...
define('src/model/tasks',['order!backbone', 'order!libs/backbone-localstorage', 'src/model/task'], function(Backbone, Store, Task) {
...
define('src/main',['order!underscore', 'order!jquery', 'order!backbone', 'order!libs/backbone-localstorage', 'src/model/task', 'src/model/tasks']);